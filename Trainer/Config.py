...
def get_gail_args():
    ...
    parser.add_argument('--disc_lr', type=float, default=0.001, help='discriminator network learning rate')
    ...
    parser.add_argument('--disc_train_epochs', type=int, default=15, help='disc train epoches')
    parser.add_argument('--batch_size', type=int, default=256, help='disc train batch size')
    ...
    parser.add_argument('--checkpoint_dir', type=str, default="./checkpoint", help='path for checkpoint')
    parser.add_argument('--save_freq', type=int, default=250, help='how often to save checkpoint')
